...
function JumpToDay()
{
	...
	{
    case 0: //Nedelja
			if (dateObj.getHours() < DAYSTARTHH) { location.replace("tram_S_" + x + ".html"); }
			else { location.replace("tram_N_" + x + ".html"); }
    break;
    case 6: //Subota
			if (dateObj.getHours() < DAYSTARTHH) { location.replace("tram_RD_" + x + ".html"); }
      else { location.replace("tram_S_" + x + ".html"); }
    break;
		case 1: //Pon
			if (dateObj.getHours() < DAYSTARTHH) { location.replace("tram_N_" + x + ".html"); }
      else { location.replace("tram_RD_" + x + ".html"); }		
		break;
    default: //Ut-Pet
			location.replace("tram_RD_" + x + ".html");
    }
}
